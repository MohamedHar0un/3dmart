...
6. **Principal review:** dispatch `principal-reviewer` (Opus 5.5, max effort) with the acceptance table, test summary, security result and the diff range. Address every issue it ranks as expensive to fix later, or record why not in an ADR.
